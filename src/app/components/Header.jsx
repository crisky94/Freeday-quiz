      ...
      <nav className='nav-header'>
        {user ? (
          <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
            ...
            <div className="flex flex-row justify-between items-center text-center w-full px-4  gap-5">
            <User />
          ...
          <p className='flex flex-row justify-center items-center'>{nickname}</p> 
          </div> 
