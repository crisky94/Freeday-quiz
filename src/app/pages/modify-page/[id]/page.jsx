  ...
  return (
    <form className="flex flex-col items-center w-full max-w-3xl mx-auto p-4" onSubmit={handleSubmit}>
      ...
      <div className="flex justify-center w-full">
        <button type="submit" className="mb-8 mt-4 select-none rounded-lg bg-blue-500 py-4 px-6 text-center align-middle font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-85 focus:shadow-none active:opacity-85 active:shadow-none disabled:opacity-50 disabled:shadow-none">
          Guardar
        </button>
      </div>
    </form>
