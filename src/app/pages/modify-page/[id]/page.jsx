...
//       asks: [
//         ...prevData.asks,
//         { ask: '', a: '', b: '', c: '', d: '', answer: null, timer: 5 },
//       ],
//     }));
//   };
...
//                           ? 'bg-[#00ff01] focus:ring-green-800'
//                           : 'bg-[#fcff00] focus:ring-yellow-600'
//                       } text-black text-center p-2 rounded-md h-auto px-2
//                       placeholder:text-justify
//                       focus:outline-none focus:ring-2 ring-yellow-400 mb-4 w-full resize-none overflow-hidden`}
//                     id={`${option}-${index}`}
//                     name={`${option}-${index}`}
...
//               <button
//                 type="button"
//                 className="btn-delete mt-2 bg-red-500 text-white rounded-md px-4 py-2"
...
//       <button
//         type="button"
//         className="btn-add mt-5 bg-green-500 text-white rounded-md px-4 py-2"
