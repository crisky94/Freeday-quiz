    ...
    <div className="w-full h-auto p-4 mt-10 rounded-lg shadow-2xl  sm:p-6">
      {games.length > 0 ? (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {games.map((game, i) => (
            <div key={game.id} className="card w-full bg-slate-100 text-black shadow-xl border rounded-md p-4 justify-center items-center text-center">
              <figure className='flex flex-col justify-center items-center text-center'>
                <Image src="/js.png" alt={game.nameGame} className=" W-full rounded-md " height={300} width={300} />
              </figure>
              <div className="card-body">
                <h2 className="card-title font-bold ">{i + 1}. {game.nameGame}</h2>
